...
using TallerApp.Helpers.HttpMessageHandlers;
...
namespace TallerApp
{
    internal class Startup
    {
        ...
        private const string SERVICES_NAMESPACE = "TallerApp.Services";
        //private const string SINGLE_INSTANCE_SERVICES_NAMESPACE = "ExampleApp.Services.SingleInstance";
        private const string VIEW_MODELS_NAMESPACE = "TallerApp.ViewModels";
        ...
        static Startup()
        {
            ...
            serviceCollection.AddRefitClient<IStorieApi>(refitSettings)
                .ConfigureHttpClient(c => c.BaseAddress = new Uri(Settings.ApiBaseUri))
                .AddHttpMessageHandler<BaseAddressHandler>();
